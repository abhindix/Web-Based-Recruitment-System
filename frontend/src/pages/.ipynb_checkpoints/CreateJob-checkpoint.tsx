        ...
        <Card>
          <form className="space-y-4" onSubmit={submit}>
            ...
            <div>
              ...
              <textarea className="mt-1 w-full rounded-xl border p-3" rows={6} value={requirements} onChange={e=>setReq(e.target.value)} />
            </div>
            <div>
            ...
            <p className="text-sm text-gray-500">Hiring manager: you</p>
